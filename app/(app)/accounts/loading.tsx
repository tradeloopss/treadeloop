...
// account list with the side note beside it (≥ 1100px) or under it —
// arranged by the same breakpoints as components/accounts/accounts-hub.
            ...
            <div className="mt-4 overflow-hidden rounded-xl border">
              {Array.from({ length: 4 }, (_, i) => (
                <div key={i} className="flex min-h-[60px] items-center gap-3 border-b px-4 py-2.5 last:border-b-0">
                  ...
                  <Bar className="hidden h-4 w-20 @[900px]/page:block" />
                </div>
              ))}
            </div>
          </div>
