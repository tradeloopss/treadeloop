...
export default async function AccountsPage({ searchParams }: { searchParams: Promise<{ connect?: string }> }) {
  ...
  return (
    <div>
      <PageHeader
        breadcrumb={[{ label: t("Settings"), href: "/settings" }, { label: t("Accounts") }]}
        title={t("Accounts")}
        description={t("Manage where your trades come from — connect platforms, check sync health and keep your journal current.")}
      />
