...
import { EXTENSION_DOWNLOAD_PATH, EXTENSION_STORE_URL, freshPairingFor } from "@/lib/tradingview-pairing"
...
export default async function ExtensionPairPage() {
  ...
  return (
    <div>
      <PageHeader title={t("TradingView auto-sync")} description={t("Pair your browser once — every paper trade lands in your journal on its own.")} />
      <TradingViewPair pairingId={pairing.id} token={pairing.token} storeUrl={EXTENSION_STORE_URL} downloadPath={EXTENSION_DOWNLOAD_PATH} />
    </div>
  )
}
