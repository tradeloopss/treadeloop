...
function DashboardMockup() {
  return <div className="dashboard-wrap" aria-label="Trading dashboard preview">
    <div className="dashboard-card">
      <aside className="dash-side"><div className="dash-mini-logo"><Image src="/logo-mark.png" alt="" width={22} height={22} /></div><div className="dash-nav active">▦ <span>Dashboard</span></div><div className="dash-nav">◷ <span>Day View</span></div><div className="dash-nav">↗ <span>Trade View</span></div><div className="dash-nav">▤ <span>Notebook</span></div><div className="dash-nav">◒ <span>Reports</span></div><div className="dash-nav">◫ <span>Trade Replay</span></div></aside>
